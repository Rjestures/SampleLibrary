package com.rjesture.firstapplibrary;
...
//                .appendQueryParameter("tr", "rjpay85232423424")
        ...
        if (null != chooser.resolveActivity(getPackageManager())) {
            ...
            Toast.makeText(mActivity, "No UPI app found, please install one to continue", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void upiPaymentDataOperation(ArrayList<String> data) {
        if (isConnectionAvailable(mActivity)) {
            ...
            Toast.makeText(mActivity, "Internet connection is not available. Please check and try again", Toast.LENGTH_SHORT).show();
        }
    }
